                    ...
                    <div class="col-md-9 md-margin-bottom-40">
                        <div class="tab-v1">
                            <ul class="nav nav-justified nav-tabs">
                                ...
                                <li class=""><a  href="admin/admincomments" aria-expanded="false">ApprovedComments</a></li>
                                <li class="active"><a  href="admin/adminflaggedcomments" aria-expanded="false">FlaggedComments</a></li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row clients-page">
                                    ...
                                    <div class="col-md-9"><hr>
                                        ...
                                        <p>Sed viverra cursus nibh, sed consectetur aipsum asoallicitudin sed. Cras erat est, euismod id congue sed, sollicitudin sed odio. Nullam non metus in mi rhoncus efficitur</p>
                                        <div class="icons">
                                            <p style="font-size:15px;font-color:red">

                                                <a href="#"><span><i class="fa fa-exclamation-circle">&nbsp;Approve</i></span></a>&nbsp;&nbsp;&nbsp;
