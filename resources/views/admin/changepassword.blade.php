                    ...
                    <div class="col-md-9 row margin-bottom-80">
                        <div class="tab-v1">
                            <ul class="nav nav-justified nav-tabs">
                                <li class="admin/settings"><a  href="#" aria-expanded="true">Profiles</a></li>
                                <li class="active"><a  href="admin/changepassword" aria-expanded="false">Change Password</a></li>
                        ...
                        <div class="security-settings">
                            ...
                            <form class="form-horizontal email-form" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 input-group">
                                        <span class="input-group-addon"><i class="fa fa-key fa-fw"></i></span>
                                        <input class="form-control" type="password" id="cnf-pwd" placeholder="Enter your Password">
                                    </div>
                                </div>
                                <div align="middle">
