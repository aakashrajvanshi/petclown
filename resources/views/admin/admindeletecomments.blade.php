                ...
                <div class="col-md-9 md-margin-bottom-40">
                    <div class="tab-v1">
                        <ul class="nav nav-justified nav-tabs">
                            ...
                            <li class="active"><a  href="admin/admindeletecomments" aria-expanded="false">Delete</a></li>
                                ...
                                <div class="col-md-9"><hr>
                                    ...
                                    <div class="icons">
                                        <p style="font-size:15px;font-color:red">
                                            ...
                                            <a href="#"><span><i class="fa fa-exclamation-circle">&nbsp;Restore</i></span></a>&nbsp;&nbsp;&nbsp;
