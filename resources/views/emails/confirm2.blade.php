                            ...
                            <table cellpadding="0" cellspacing="0" class="force-full-width">
                                <tr>
                                    <td height="60" valign="top" class="header-cell">
                                        <img width="200" height="60" src="http://www.mrpetition.com/images/default/logo.png" alt="Mr. Petition logo">
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                                                    <h1>Welcome to Mr. Petition</h1>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    <b><br>Hey {{ $name }}, thanks for signing up!</b><br><br>
                                                    We're really excited for you to join our community! Please confirm your email id and activate your account.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                            ...
                                                            <td style="width:200px;background:#008000;">
                                                                <div><!--[if mso]>
                                                                    <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:40px;v-text-anchor:middle;width:200px;" stroke="f" fillcolor="#008000">
                                                                        ...
                                                                        <center>
                                                                    <![endif]-->
                                                                    <a href="http://petclown.com/confirm/{{$token}}"
                                                                       style="background-color:#008000;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Confirm Email</a>
                                                                    <!--[if mso]>
                                                                    </center>
                                                                    </v:rect>
                                                                    <![endif]--></div>
