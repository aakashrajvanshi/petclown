                                                            ...
                                                            <td style="width:200px;background:#008000;">
                                                                <div><!--[if mso]>
                                                                    ...
                                                                    <a href="{{ url('password/reset/'.$token) }}"
                                                                       style="background-color:#008000;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Reset Password</a>
                                                                    <!--[if mso]>
                                                                    </center>
                                                                    </v:rect>
                                                                    <![endif]--></div>
